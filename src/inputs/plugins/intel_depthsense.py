...
Support fo the DepthSense is erratic; current state of support on Jetpack 6.1 on Nvidia not clear.

For Mac:

https://lightbuzz.com/realsense-macos/

NOTE: make sure your Xcode has permissions to access your documents
folder otherwise you will get strange permission errors.

NOTE: On Mac, you will need to patch the cmake. See
https://github.com/IntelRealSense/librealsense/issues/11978
This gives you a universal binary, if for whatever reason the
prebuilt binary does not work.
